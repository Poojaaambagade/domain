...
//        LatLng garage1 = new LatLng(19.9974, 73.7898); // Nashik
//        LatLng garage2 = new LatLng(19.0759, 72.8776); // Mumbai

        LatLng garage1 = new LatLng(20.745319, 78.602196); // wardha
        LatLng garage2 = new LatLng(18.520430, 73.856743); // pune

        // Add markers to the map
        mMap.addMarker(new MarkerOptions().position(garage1).title("Service Center 1")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
        mMap.addMarker(new MarkerOptions().position(garage2).title("Service Center 2")
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
